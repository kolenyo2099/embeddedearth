...
class FourierExpansion(nn.Module):
    ...
    def forward(self, x: torch.Tensor, d: int) -> torch.Tensor:
        ...
        # Disabled generic assertion for robustness in this integration
...
_min_patch_area: float = 0.0 # Placeholder, area() requires dummy input to calc logic above
...
scale_expansion = FourierExpansion(1e-4, _area_earth) # Use safe defaults
